...
public class WebServiceDSManager implements DSManagerInterface {
    ...
    public WebServiceDSManager(String bootStrapIp, int bootStrapPort, String myIp, FSViewController controller) {
    ...
    public WebServiceDSManager(String bootStrapIp, int bootStrapPort, String myIp, int myPort, FSViewController controller) {
        this.bootStrapIp = bootStrapIp;
        this.bootStrapPort = bootStrapPort;
        this.controller = controller;
